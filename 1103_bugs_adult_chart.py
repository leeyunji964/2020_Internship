...
#year = [6804,6808,6809,6810,6811,6812,6813] # 1960년대 - 여기부터 저장명 조금 수정해야 함 1960~1963, 64,65,66,67,68,69
...
for i in range(len(year)):
    # 1. url 받아오기
    url = 'https://music.bugs.co.kr/genre/kpop/adultkpop/trot' + str(year[i]) + '?tabtype=7'
    ...
    writer = pd.ExcelWriter("Bugs_Adult_Chart" + str(i+1) + ".xlsx")
